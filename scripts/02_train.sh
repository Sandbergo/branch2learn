...
python branch2learn/02_train.py -p setcover -m mlp3 -g 0
...
python branch2learn/02_train.py -p cauctions -m mlp3 -g 0
...
python branch2learn/02_train.py -p indset -m mlp3 -g 0
